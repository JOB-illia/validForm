...
/* harmony import */ var _modules_validation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/validation */ "./src/js/modules/validation.js");

window.addEventListener('DOMContentLoaded', function () {
  var valid = new _modules_validation__WEBPACK_IMPORTED_MODULE_0__["default"]();
  valid.init();
});
...
function () {
  ...
  _createClass(Validation, [{
    key: "validForm",
    value: function validForm(input, type) {
      if (type == 'email') {
        var re = /[_a-z\d\-\.]+@[_a-z\d\-]+(\.[_a-z\d\-]+)/gi;
    ...
    value: function init() {
      ...
      this.btn.addEventListener('mouseover', function () {
        _this.validForm(_this.inputName, 'text');

        _this.validForm(_this.inputEmail, 'email');

        _this.validForm(_this.inputTel, 'tel');
      });
      this.inputName.addEventListener('input', function () {
        _this.validForm(_this.inputName, 'text');
      });
      this.inputEmail.addEventListener('input', function () {
        _this.validForm(_this.inputEmail, 'email');
      });
